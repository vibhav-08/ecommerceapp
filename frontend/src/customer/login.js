...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        await axios.post("/customer/login", login_data).then((res) => {
            console.log(login_data);
            console.log(res.data);
            if (res.data.msg) { console.log("You are not logged in"); }
            else { console.log("Calling from login POST Aprroved"); console.log("Correct combination"); window.location.href = '/customer/home' }
        });
    }
